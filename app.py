# =========================================================
# WiseMate – Student Lifestyle & Productivity Assistant
# Stable version
...
st.markdown(f"""
<div class='subtitle'>
Hi {name}! I’m <b>WiseMate</b>, your student lifestyle and productivity assistant.  
I help you manage studies, stress, routines, sleep, and motivation.
</div>
""", unsafe_allow_html=True)
...
def bot_reply(message):
    ...
    advice = [
        ...
        "🌟 Remember: small consistent steps beat long distractions!"
    ]
...
if send and user_input:
    ...
    st.session_state.input_field = ""  # clear input after send
